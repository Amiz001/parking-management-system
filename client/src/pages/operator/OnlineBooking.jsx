              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-400">
                    ...
                    <th className="text-left py-3 px-4 text-gray-400 light:text-gray-700 font-medium">Customer Name</th>
                    <th className="text-left py-3 px-4 text-gray-400 light:text-gray-700 font-medium">Customer Phone</th>
