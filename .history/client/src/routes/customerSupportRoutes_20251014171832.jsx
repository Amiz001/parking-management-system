...
import Complains from "../pages/customerSupport/Complain-requests";
...
const customerSupportRoutes = [
  ...
  { path: "/customersupport/Comreq" ,element:<Complains/>} ,
  { path: "/customersupport/ticket-request" ,element:<Tick/>} ,              
