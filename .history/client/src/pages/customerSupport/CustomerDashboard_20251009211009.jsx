...
const Dashboard = () => {
  ...
  const sidebarItems = [
    ...
    { icon: SquareParking, label: "Feedback" },
    { icon: HeartHandshake, label: "Refund Request" },
    { icon: BanknoteArrowDown, label: "Ticket Request" },
    { icon: BanknoteArrowDown, label: "Complaint Request" },
