...
const TicketDashboard = () => {
  ...
  // Sidebar items
  const sidebarItems = [
    { icon: Ticket, label: "Ticket Requests", link: "/customersupport/ticket-requests" },
    { icon: AlertCircle, label: "Complaint Requests", link: "/customersupport/comreqy" },
    { icon: MessageSquare, label: "Feedback Requests", link: "/customersupport/feedback-requests" },
  ];
