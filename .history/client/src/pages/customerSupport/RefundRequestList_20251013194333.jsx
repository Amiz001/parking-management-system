...
const RefundDashboard = () => {
  ...
  return (
    <div className={`flex h-auto text-white ${lightMode ? "light text-black bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100" : "bg-gradient-to-br from-gray-900 via-blue-900 to-black"}`}>
      ...
      <div className="flex-1 flex flex-col p-6">
        ...
        <div className="overflow-x-auto bg-gradient-to-b from-gray-900 via-blue-900 to-black rounded-xl p-4 backdrop-blur-md shadow-lg">
          <table className="w-full table-auto">
            ...
            <tbody>
              {filteredRefunds.map((refund) => (
                <tr key={refund._id} className="border-b border-blue-700 hover:bg-blue-800 transition-colors">
        ...
        {replyPopup.open && currentRefund && (
          <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
            <div className="bg-gradient-to-br from-blue-900 via-blue-800 to-gray-900 p-6 rounded-xl w-96 shadow-xl backdrop-blur-md">
              <h2 className="text-xl font-bold mb-3 text-white">Reply to Refund</h2>
