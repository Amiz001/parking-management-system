  ...
  return (
    <div className={`flex h-auto bg-gray-950 text-white ${lightMode ? "light bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 text-black" : ""}`}>
      ...
      <div className="flex-1 flex flex-col">
        ...
        {/* Enhanced Reply Popup */}
        {replyPopup.open && (
          <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-4">
            <div className="bg-gradient-to-br from-purple-700 via-pink-500 to-orange-400 p-6 rounded-2xl w-full max-w-lg shadow-lg relative">
              <h2 className="text-2xl font-bold text-white mb-4">Send Reply</h2>

              {previousReply && (
                <div className="bg-white p-3 rounded-md mb-4 text-gray-800">
              ...
              <textarea
                ...
                className="w-full h-24 p-3 mb-3 rounded-md"
              />
              ...
              <textarea
                ...
                className="w-full h-20 p-3 mb-3 rounded-md"
              />

              <div className="flex justify-end gap-3 mt-2">
                <button onClick={() => setReplyPopup({ open: false, refundId: null })} className="px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300">Cancel</button>
                <button onClick={handleReplySend} className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Send Reply</button>
              </div>
            </div>
          </div>
        )}
