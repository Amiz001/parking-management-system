        ...
        <header className="bg-gray-950 p-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <div className="relative">
              ...
              <input type="text" placeholder="Search complaints..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)} className="pl-10 pr-4 py-2 bg-[#151821] border border-gray-900 rounded-lg text-white focus:ring-2 focus:ring-red-500" />
            </div>
            </div>
          </div>
              ...
              <tbody>
                {filteredComplaints.map(c => (
                  <tr key={c._id} className="border-b border-gray-700 hover:bg-gray-700">
                    ...
                    <td className="py-2 px-3 max-w-xs">{c.description || "-"}</td>
