...
const CustomerSupportPage = () => {
  ...
  const sidebarItems = [
    ...
    { icon: AlertCircle, label: "Complain Request", link: "/customersupport/comreq" },
      ...
      <div className="w-64 h-screen bg-[#151821] p-6 flex flex-col">
        ...
        <div className="mt-auto space-y-2">
          {bottomItems.map((item, i) => (
            <a
              key={i}
              onClick={() => navigate(item.link)}  // ✅ Works now
      ...
      <div className="flex-1 flex flex-col">
        <header className="bg-gray-950 p-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Settings
              size={20}
              onClick={() => navigate("/customersupport/setting")} // ✅ Direct settings icon navigation
