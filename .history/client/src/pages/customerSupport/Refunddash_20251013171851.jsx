// RefundDashboardWithReplySimplified.jsx
...
import { Search, Settings, Bell, Sun, Moon, LogOut, Megaphone } from "lucide-react";
...
const RefundDashboardWithReplySimplified = () => {
  ...
  const sidebarItems = [
    { label: "Ticket Request", link: "/admin/ticket-requests" },
    { label: "Complain Request", link: "/admin/complain-requests" },
    { label: "Feedback Request", link: "/admin/feedback-requests" },
  ];
