...
import { Search, Settings, Bell, Sun, Moon, ChartColumnBig, SquareParking, HeartHandshake, BanknoteArrowDown, Megaphone, Users, Car, LogOut } from "lucide-react";
        ...
        {replyPopup.open && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-gradient-to-br from-blue-700 via-blue-500 to-blue-600 p-6 rounded-3xl w-full max-w-md relative z-10">
              {/* Planet circles */}
              <div className="absolute -top-20 -left-20 w-40 h-40 rounded-full bg-blue-400 opacity-30 animate-pulse"></div>
              <div className="absolute -bottom-20 -right-20 w-32 h-32 rounded-full bg-indigo-400 opacity-30 animate-pulse"></div>
