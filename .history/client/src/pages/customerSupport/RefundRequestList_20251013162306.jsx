                    ...
                    <tr key={refund._id} className="border-b border-gray-700 hover:bg-gray-700">
                      ...
                      <td className="py-3 px-4 relative">
                        ...
                        {menuIndex === index && (
                          <div
                            ref={menuRef}
                            className="absolute right-[2%] bottom-full mb-2 bg-gray-900 text-white border border-gray-700 rounded-md shadow-lg z-20"
                          >
                            <ul className="divide-y divide-gray-700">
                              ...
                              <li className="px-4 py-2 hover:bg-red-600 cursor-pointer flex items-center gap-2" onClick={() => handleDelete(refund._id)}>
