...
const RefundDashboardWithReply = () => {
        ...
        <div className="mb-8">
          ...
          <nav className="space-y-2">
            {sidebarItems.map((item, i) => (
              <a key={i} onClick={() => navigate(item.link)} className="flex items-center gap-3 px-3 py-2 rounded-lg text-gray-300 hover:bg-gradient-to-r from-blue-500 to-indigo-600 transition-colors">
                <item.icon size={20} />
...
export default RefundDashboardWithReply;
