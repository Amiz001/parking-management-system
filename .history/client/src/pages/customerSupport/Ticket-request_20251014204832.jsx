  ...
  return (
    <div className={`flex min-h-screen ${lightMode ? "bg-gray-100 text-black" : "bg-gray-950 text-white"}`}>
      ...
      <div className="flex-1 flex flex-col">
        {/* HEADER (Updated like RefundDashboard) */}
        <header className="bg-gray-950 p-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() => setFilteredTickets(tickets.filter((t) =>
                  Object.values(t).join(" ").toLowerCase().includes(searchTerm.toLowerCase())
                ))}
        ...
        <main className="flex-1 p-6 overflow-auto">
          <div className="flex items-center justify-between mb-8">
            <h1 className="text-3xl text-bold mb-2">Tickets Requests</h1>
            <h1 className="text-L mb-2">Tickets are available here</h1>
            <div className="flex items-center gap-4">
