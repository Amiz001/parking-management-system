...
const Dashboard = () => {
  ...
  const sidebarItems = [
    ...
    { icon: BanknoteArrowDown,link:"/admin/slot-management", label: 'Refund requests' },
  ...
  const userItems = [
    ...
    { icon: Car, link:"/admin/slot-management", label: 'Vehicles' },
  ];

  const bottomItems = [
    { icon: Settings, link:"/admin/slot-management", label: 'Settings' },
