      ...
      >
        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className={`w-full py-3 font-semibold rounded-lg transition transform hover:scale-[1.02] shadow-md ${
                lightMode
                  ? "bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 text-white hover:opacity-90"
                  : "bg-gradient-to-r from-[#1e3a8a] via-[#6d28d9] to-[#a21caf] text-white hover:opacity-90"
              }`}
            >
              🚀 Submit Feedback
            </button>
