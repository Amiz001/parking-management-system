...
import PopupForm from "../../components/PopupForm"; // Reuse your existing popup form
        ...
        <main className="flex-1 p-6 overflow-auto">
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                className="bg-indigo-600 text-white rounded-sm px-2 py-[3px] cursor-pointer flex gap-1 items-center"
                onClick={handleAdd}
              >
          ...
          {/* Add/Update refund popup */}
          <PopupForm
            status={isOpen}
            mode={mode}
            selectedUser={selectedRefund}
