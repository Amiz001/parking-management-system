...
const ComplaintDashboard = () => {
  ...
  const exportToExcel = () => {
    ...
    saveAs(new Blob([excelBuffer], { type: "application/octet-stream" }), "complaints.xlsx");
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="bg-gray-950 p-6 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <button onClick={handleSearch} className="px-3 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 flex items-center gap-2">
              ...
              <tbody>
                {filteredComplaints.map((c) => (
                  <tr key={c._id} className="border-b border-gray-700 hover:bg-gray-700">
                    ...
                    <td className="py-2 px-3 max-w-xs">{c.description.length > 50 ? `${c.description.slice(0,50)}...` : c.description}</td>
