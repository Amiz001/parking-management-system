...
const FeedbackDashboard = () => {
  ...
  return (
    <div className={`flex h-auto ${lightMode ? "bg-gray-100 text-black" : "bg-gray-950 text-white"}`}>
      {/* Sidebar */}
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="bg-gray-950 p-6 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={() => filterFeedbacks(searchTerm)}
        ...
        <main className="flex-1 p-6 overflow-auto">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-gray-400">All feedbacks are listed below</p>
            </div>
            <div className="flex items-center gap-4">
              ...
              <tbody>
                {filteredFeedbacks.map((f) => (
                  <tr key={f._id} className="border-b border-gray-700 hover:bg-gray-700">
                    <td className="py-2 px-3">FB{f._id?.slice(0, 4) || "----"}</td>
