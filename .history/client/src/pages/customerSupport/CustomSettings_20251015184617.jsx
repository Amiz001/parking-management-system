...
const CustomerSettingsLayout = () => {
  ...
  const sidebarItems = [
    { icon: User, label: "Account", path: "/customer/settings/account" },
    { icon: Car, label: "Vehicles", path: "/customer/settings/vehicles" },
    { icon: CreditCard, label: "Payments", path: "/customer/settings/payments" },
    ...
    { icon: HelpCircle, label: "Help Center", path: "/customer/settings/help" },
  ];
