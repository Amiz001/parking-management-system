...
const sidebarItems = [
    ...
    { icon: CalendarCheck , label: 'Refund Requests', path: "/customerSupport/RefundForm" },
    { icon: CalendarCheck, label: 'Feedback Requests', path: "/operator/onlinebooking"},
    { icon: HeartHandshake, label: 'complaints', path: "/operator/membershipplan"},
    { icon: HeartHandshake, label: 'Ticket request', path: "/operator/OnlineBookingPage"},
